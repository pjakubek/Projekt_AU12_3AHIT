...
public class View {
	...
	public View(Control c) {
		...
		combobox.setBounds(226, 14, 150, 20);
		...
		keyfield.setText("abcdefghijklmnopqrstuvwxyzäöüß");
	...
	public void encrypt() {
		...
		case 0:
			...
			this.c = new MonoalphabeticCipher(keyfield.getText());
			break;
			
		case 1:

			this.c = new ShiftCipher(Integer.parseInt(keyfield.getText()));
			break;
			
		case 2:

			this.c = new KeywordCipher(keyfield.getText());
			break;
	...
	public void decrypt() {
		...
		case 0:
			...
			this.c = new SubstitutionCipher(keyfield.getText());
			break;
